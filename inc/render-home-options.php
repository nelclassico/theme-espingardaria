...
<div class="theme-options-section">
    ...
    <!-- Seção de Banner Destaque -->

    <div class="theme-options-section">

        <div class="theme-options-section-header">

            <h3><?php esc_html_e('Seção de Banner destaque 01', 'theme-espingardaria'); ?></h3>
        ...
        <div class="theme-options-section-content">
            ...
            <div class="theme-options-field">
                ...
                <label>
                    ...
                    <input type="checkbox" name="theme_espingardaria_options[show_destaque_1]" <?php checked($options['show_destaque_1'] ?? true); ?>>

                    <?php esc_html_e('Mostrar Seção de Banner de Destaque 01', 'theme-espingardaria'); ?>
            ...
            <div class="theme-options-field">
                ...
                <input type="text" name="theme_espingardaria_options[destaque_1_title]" value="<?php echo esc_attr($options['destaque_1_title'] ?? ''); ?>">
            ...
            <div class="theme-options-field">
                ...
                <textarea name="theme_espingardaria_options[destaque_1_text]" rows="5"><?php echo esc_textarea($options['destaque_1_text'] ?? ''); ?></textarea>
            ...
            <div class="theme-options-field">
                ...
                <input type="text" name="theme_espingardaria_options[destaque_1_button_text]" value="<?php echo esc_attr($options['destaque_1_button_text'] ?? ''); ?>">
            ...
            <div class="theme-options-field">
                ...
                <input type="text" name="theme_espingardaria_options[destaque_1_button_url]" value="<?php echo esc_attr($options['destaque_1_button_url'] ?? ''); ?>">
            ...
            <div class="theme-options-field">
                ...
                <div class="media-uploader">
                    ...
                    <input type="hidden" name="theme_espingardaria_options[destaque_1_image]" value="<?php echo esc_attr($options['destaque_1_image'] ?? ''); ?>" class="media-input">

                    <div class="media-preview">

                        <?php if (!empty($options['destaque_1_image'])) : ?>

                            <img src="<?php echo esc_url($options['destaque_1_image']); ?>" alt="">
    ...
    <!-- Seção de Banner Destaque 02 -->

    <div class="theme-options-section">

        <div class="theme-options-section-header">

            <h3><?php esc_html_e('Seção de Banner destaque 02', 'theme-espingardaria'); ?></h3>
        ...
        <div class="theme-options-section-content">
            ...
            <div class="theme-options-field">
                ...
                <label>
                    ...
                    <input type="checkbox" name="theme_espingardaria_options[show_destaque_2]" <?php checked($options['show_destaque_2'] ?? true); ?>>

                    <?php esc_html_e('Mostrar Seção de Banner de Destaque 02', 'theme-espingardaria'); ?>
            ...
            <div class="theme-options-field">
                ...
                <input type="text" name="theme_espingardaria_options[destaque_2_title]" value="<?php echo esc_attr($options['destaque_2_title'] ?? ''); ?>">
            ...
            <div class="theme-options-field">
                ...
                <textarea name="theme_espingardaria_options[destaque_2_text]" rows="5"><?php echo esc_textarea($options['destaque_2_text'] ?? ''); ?></textarea>
            ...
            <div class="theme-options-field">
                ...
                <input type="text" name="theme_espingardaria_options[destaque_2_button_text]" value="<?php echo esc_attr($options['destaque_2_button_text'] ?? ''); ?>">
            ...
            <div class="theme-options-field">
                ...
                <input type="text" name="theme_espingardaria_options[destaque_2_button_url]" value="<?php echo esc_attr($options['destaque_2_button_url'] ?? ''); ?>">
            ...
            <div class="theme-options-field">
                ...
                <div class="media-uploader">
                    ...
                    <input type="hidden" name="theme_espingardaria_options[destaque_2_image]" value="<?php echo esc_attr($options['destaque_2_image'] ?? ''); ?>" class="media-input">

                    <div class="media-preview">

                        <?php if (!empty($options['destaque_2_image'])) : ?>

                            <img src="<?php echo esc_url($options['destaque_2_image']); ?>" alt="">
 ...
 <!-- GALERIA -->
    <!-- Galeria de Imagens -->
        ...
        <div class="theme-options-section">
            <div class="theme-options-section-header">
                <h3><?php esc_html_e('Galeria de Imagens', 'theme-espingardaria'); ?></h3>
            </div>
            <div class="theme-options-section-content">
                <div class="theme-options-field">
                    <label>
                        <input type="checkbox" name="theme_espingardaria_options[show_image_gallery]" <?php checked($options['show_image_gallery'] ?? true); ?>>
                        <?php esc_html_e('Mostrar Seção Galeria de Imagens', 'theme-espingardaria'); ?>
                    </label>
                </div>

                <div class="theme-options-field">
                    <label><?php esc_html_e('Título da Galeria', 'theme-espingardaria'); ?></label>
                    <input type="text" name="theme_espingardaria_options[image_gallery_title]" value="<?php echo esc_attr($options['image_gallery_title'] ?? ''); ?>">
                </div>

                <div class="theme-options-field">
                    <label><?php esc_html_e('Imagens da Galeria', 'theme-espingardaria'); ?></label>
                    <div class="multiple-media-uploader">
                        <input type="hidden" name="theme_espingardaria_options[image_gallery_images]" value="" class="multiple-media-input" data-images="<?php echo esc_attr(json_encode($options['image_gallery_images'] ?? array())); ?>">
                        <div class="multiple-media-preview">
                            <?php
                            if (!empty($options['image_gallery_images']) && is_array($options['image_gallery_images'])) {
                                foreach ($options['image_gallery_images'] as $image) {
                                    if (!empty($image)) {
                                        echo '<div class="multiple-media-item"><img src="' . esc_url($image) . '" alt="" style="width: 100px"><button type="button" class="button remove-multiple-media">Remover</button></div>';
                                    }
                                }
                            }
                            ?>
                        </div>
                        <div class="multiple-media-buttons">
                            <button type="button" class="button upload-multiple-media"><?php esc_html_e('Selecionar Imagens', 'theme-espingardaria'); ?></button>
                        </div>
                    </div>
                    <p class="description"><?php esc_html_e('Selecione múltiplas imagens para o carrossel da galeria.', 'theme-espingardaria'); ?></p>
                </div>
            </div>
        </div>